...
import (
	...
	"github.com/d-sparks/gravy/algorithm/buygoodandhold"
	algorithmio_pb "github.com/d-sparks/gravy/algorithm/proto"
	"google.golang.org/grpc"
)

var (
	id              = flag.String("id", "buygoodandhold", "Algorithm ID.")
	port            = flag.Int("port", 17504, "Port for rpc server.")
...
func main() {
	...
	algorithmServer := buygoodandhold.New(*id, *rebalancePeriod)
